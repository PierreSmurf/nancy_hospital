...
RegisterNetEvent("grp-hospital:items:bandage")
AddEventHandler("grp-hospital:items:bandage", function(item)
    HealSlow2()
end)
...
RegisterNetEvent("grp-hospital:items:ifak")
AddEventHandler("grp-hospital:items:ifak", function(item)
    ...
    exports["grp-taskbar"]:taskBar(3500, "Using IFAK")
